...
**Preserves**: §0034 (prophet pipeline), §0035, §0036, §0037 (`fitPlanToBudget` still runs after `resolveDraftSteps`), §0030/§0031/§0033, the `IReconnoiterer`/`IDirector` port signatures, the on-camera `Performance` step shapes, `RECON_REHEARSE=false` ⇒ behaviour as before.
