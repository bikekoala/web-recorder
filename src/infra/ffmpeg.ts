...
/**
 * Probe a video's duration in milliseconds. Uses ffmpeg (not ffprobe, which
 * Playwright doesn't bundle): runs ffmpeg with `-i` and parses stderr.
 * Imprecise (~50ms tolerance) — fine for logging / sanity checks.
 */
